...
setOrdererGlobals() {
        ...
        CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/bridgelabz.com/orderers/orderer.bridgelabz.com/msp/tlscacerts/tlsca.bridgelabz.com-cert.pem
        CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/bridgelabz.com/users/Admin@bridgelabz.com/msp
}
...
setGlobals () {
	...
	if [ $ORG -eq 1 ] ; then
		...
		# else
		# 	CORE_PEER_ADDRESS=peer1.importer.bridgelabz.com:7051
		fi
	elif [ $ORG -eq 2 ] ; then
		CORE_PEER_LOCALMSPID="ExporterMSP"
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/exporter.bridgelabz.com/peers/peer0.exporter.bridgelabz.com/tls/ca.crt
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/exporter.bridgelabz.com/users/Admin@exporter.bridgelabz.com/msp
		if [ $PEER -eq 0 ]; then
			CORE_PEER_ADDRESS=peer0.exporter.bridgelabz.com:7051
		# else
		# 	CORE_PEER_ADDRESS=peer1.exporter.bridgelabz.com:7051
		fi

	elif [ $ORG -eq 3 ] ; then
		CORE_PEER_LOCALMSPID="CustomMSP"
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/custom.bridgelabz.com/peers/peer0.custom.bridgelabz.com/tls/ca.crt
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/custom.bridgelabz.com/users/Admin@custom.bridgelabz.com/msp
		if [ $PEER -eq 0 ]; then
			CORE_PEER_ADDRESS=peer0.custom.bridgelabz.com:7051
		# else
		# 	CORE_PEER_ADDRESS=peer1.custom.bridgelabz.com:7051
		fi

	elif [ $ORG -eq 4 ] ; then
		CORE_PEER_LOCALMSPID="ImporterBankMSP"
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/importerBank.bridgelabz.com/peers/peer0.importerBank.bridgelabz.com/tls/ca.crt
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/importerBank.bridgelabz.com/users/Admin@importerBank.bridgelabz.com/msp
		if [ $PEER -eq 0 ]; then
		...
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/insurance.bridgelabz.com/peers/peer0.insurance.bridgelabz.com/tls/ca.crt
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/insurance.bridgelabz.com/users/Admin@insurance.bridgelabz.com/msp
		if [ $PEER -eq 0 ]; then
...
updateAnchorPeers() {
  ...
  if [ -z "$CORE_PEER_TLS_ENABLED" -o "$CORE_PEER_TLS_ENABLED" = "false" ]; then
                set -x
		peer channel update -o orderer.bridgelabz.com:7050 -c $CHANNEL_NAME -f ./channel-artifacts/${CORE_PEER_LOCALMSPID}anchors.tx >&log.txt
		res=$?
                set +x
  else
                set -x
		peer channel update -o orderer.bridgelabz.com:7050 -c $CHANNEL_NAME -f ./channel-artifacts/${CORE_PEER_LOCALMSPID}anchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA >&log.txt
		res=$?
                set +x
  fi
	cat log.txt
